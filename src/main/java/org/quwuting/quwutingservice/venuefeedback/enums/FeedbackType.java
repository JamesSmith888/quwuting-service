...
public enum FeedbackType {
    ...
    PRICE("价格信息缺失或有误"),
    /**
     * 门店相册照片有误（2026-08-22 新增：详情页相册图片报错入口使用——照片过时/
     * 与门店不符/加载损坏等，note 承载照片序号，管理员经相册管理端核实处理）。
     * 信息纠错性质（不在场、异步审核、不回显）归属本通道，与「报告突发事件」
     * （status-reports 实时信号）边界按信号性质划分，见 AGENTS.md「统一用户上报」。
     */
    PHOTO_ERROR("照片有误"),
    OTHER("其他问题");
