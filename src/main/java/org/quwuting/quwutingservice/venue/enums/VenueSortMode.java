 ...
 *       = 近30天去重浏览人数×0.3 + 近7天去重浏览人数×0.4 + ln(1+匿名浏览行数)×1，
 *       <b>2026-09-19 由「来源加权人次 + ln 压缩」改为人数口径</b>
 *       + 近30天收藏人数×8 + 近30天新增动态×5 + 评分人数×8 + 正向反馈人数×3
 *       + 近30天积分×pointsWeight，2026-09-01 收藏/动态存量项退出公式、2026-09-07 收藏
 *       15→8 校准、2026-09-19 主动信号与浏览同改人数口径，见 VenueHeatWeights）。
 *       <b>2026-09-01 距离加成移除</b>：旧公式含邻近加成 100/(1+距离km)，用户实证
 *       "热度 2 的本地店压过热度 17 的外地店"不合理——距离的唯一影响收敛为 300km 半径筛选，
 *       排序纯看热度（本地近 ≠ 靠前）。
 *       <b>2026-08-27 零行为守卫；2026-09-07 阈值上修 ≥15</b>：行为热度不足 15
 *       （≈ 2 次收藏量级，零行为/单点稀疏行为均不达标）的门店运营权重不生效——
 *       杜绝"零人气/恰好一个收藏的门店仅靠运营权重登顶"（悬崖解锁修复，
 *       见 VenueRepository#HEAT_SCORE）。</li>
