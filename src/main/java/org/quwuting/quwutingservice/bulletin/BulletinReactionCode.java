 ...
 * 因此收 10 枚通用情绪/态度，声明序 = 正向(6) → 中性(2) → 负向(2)（沿用域字典
 * "正向在前、负向收尾"的展示序约定），10 项恰为 Picker 4×2 + 末行 2 居中。
 * <p>
...
public final class BulletinReactionCode {
     ...
     * <ul>
     *   <li>正向 6：👍 赞 / ❤️ 红心 / 🔥 火 / 🎉 派对彩带 / 👏 鼓掌 / 🙏 双手合十</li>
     *   <li>中性 2：😮 吃惊 / 🤔 思考</li>
     *   <li>负向 2：😢 大哭 / 😡 发怒</li>
     * </ul>
     * 语义覆盖"这条情报对我的意义"：认可（赞/红心）、值得关注（火/鼓掌）、感谢告知（合十）、
     * 开业喜悦（彩带）、意外（吃惊）、待核实（思考）、坏消息（大哭/发怒）。快讯内容边界
     * 只写服务可得性，故负向情绪同样不指向具体店家（见 47 号文档内容边界红线）。
     */
