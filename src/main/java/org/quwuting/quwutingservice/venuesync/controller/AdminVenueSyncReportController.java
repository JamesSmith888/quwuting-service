...
public class AdminVenueSyncReportController {
    ...
    public ApiResponse<Page<VenueResponse>> searchVenues(
        ...
        //        radiusKm, hot, tag, hasActivity, page, size —— venueType 传 null = 不过滤类型
        //        （本选择器是管理端「平台门店」映射用，跨类型搜索是其本义；
        //         hasActivity 同传 null = 不过滤活动，管理端选择器不该被「有活动」收窄）
        return ApiResponse.ok(venueService.listVenues(
                null, null, null, null, keyword, null, null, null, null, null, null, null, null, page, size));
    }
