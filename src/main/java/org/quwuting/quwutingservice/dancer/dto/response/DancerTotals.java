...
/**
 * 舞伴累计指标（2026-08-22 追加；2026-08-26 补需求计数，{@link DancerStatsResponse#totals()}）。
 * <p>
 ...
 *       与 pointsTrend 同源）；</li>
 *   <li>需求：qwt_demand_records 行数（2026-08-26 追加，与 demandTrend 同源——
 *       "多少人想约 TA"的商业信号，见 DancerDemandStat）。</li>
 * </ul>
...
public record DancerTotals(
        ...
        /** 累计需求人次（qwt_demand_records 行数，2026-08-26 追加；与 demandTrend 同源） */
        long demandCount
) {
}
