...
public class DancerService {
     ...
     * <ul>
     *   <li>{@link DancerSortMode#HOT}（默认）：排名热度 = 近7天联系解锁数×3（付费
     *       意向主导，2026-08-29 新增）+ 近7天认可数×1（平滑项）+ 新鲜度加成
     *       （新舞伴 14 天 +2 / 近 3 天更新过相册或联系方式 +2），tie-break 依次 =
     *       近30天联系解锁数、近30天收藏数（2026-08-26 由近30天积分替换——原积分
     *       口径偏向收费舞伴），再按 id 倒序兜底（新资料优先）；排序口径与详情统计
     *       页「排名热度」卡完全一致（DancerStatsService，对齐门店「排序与热度页
     *       统一」先例），见 DancerRepository#findPublicPage；</li>
