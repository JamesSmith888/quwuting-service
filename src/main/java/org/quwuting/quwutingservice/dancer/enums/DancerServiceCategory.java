 ...
 * 酒吧不再单列类别，收编为包时子类别；2026-08-26：label 改服务端权威派生——
 * 仅 OTHER 允许手动录入服务内容）。
 * <ul>
 *   <li>{@link #PACKAGE} 包时（大类，必带 ≥1 个子类别 {@link DancerServiceSubCategory}：
 *       酒吧 / 舞厅 / 私影 / KTV / 其他，可多选；计费快捷 200/300/400）</li>
 *   <li>{@link #DANCE} 舞厅跳舞</li>
 *   <li>{@link #ONLINE_CHAT} 线上陪聊（原 ONLINE）</li>
 *   <li>{@link #OTHER} 其他（具体内容由 admin 在 label 手动录入，如「户外露营」）</li>
 * </ul>
 * 类别默认标签 = 需求弹层 chip 与服务范围卡的缺省展示名；服务短标签 label 由
 * 服务端按类别权威派生（PACKAGE = 子类别名顿号连接+「包时」，DANCE/ONLINE_CHAT =
...
public enum DancerServiceCategory {
    ...
    /** 包时（大类，子类别多选：酒吧/舞厅/私影/KTV/其他；默认标签） */
    PACKAGE("包时"),
    /** 舞厅跳舞 */
    DANCE("舞厅跳舞"),
    /** 线上陪聊 */
