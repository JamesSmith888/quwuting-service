...
| [`06-listing-and-stats.md`](docs/agents/06-listing-and-stats.md) | 复合评分排序、双查询拆分坑位、标签筛选、城市词表、isHot 热门标记、累计浏览量、**零行为权重守卫（2026-08-27：行为热度=0 门店运营权重不参与排序，HEAT_SCORE 拆 HEAT_BEHAVIOR + CASE 守卫壳）** | 列表接口 |
