...
| [`07-feedback-and-reporting.md`](docs/agents/07-feedback-and-reporting.md) | 统一用户上报（类型/状态机/防刷/**原子幂等 upsert，2026-08-20**/激励下发/**状态类类型下线与采纳联动兜底，2026-08-20**）、场所状态上报（TTL/采纳联动/紧急公告） | 上报模块 |
