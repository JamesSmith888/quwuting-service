...
- **公告已发后再补充门店 → 新发一条独立公告**（勿改写已发布公告）；原地 update 仅用于修正原公告
  ...
  🚨 **09-17 拍板「新增门店公告与每日舞讯公告必须分开」**：贴表建档批量等新增门店**一律独立成条**
  （标题「{M}月{D}日新增{N}家门店」），**禁并进当日舞讯公告**（营业名单/恢复营业版式）——
  「更新非重发」仅限同批次信息补全（实证：18 家新增段并入 #51 被打回，拆为 #51 还原 + #52 新发）。
- **表② 放行 / 单源新店录入 / 混合批次**等不确定数据写库后：**仍须主动询问用户**是否发公告。

**📋 固定模板**（category=DATA_UPDATE，pinned=true；**标题按分组选，09-14 用户纠正**：仅【新增门店】→ `{M}月{D}日新增门店`（先例 id=37/26）；含【恢复营业】→ `{M}月{D}日舞讯更新`——标题必须表达内容主体，勿一律套「舞讯更新」。**09-17 用户再拍板「新增门店公告与每日舞讯公告必须分开」**：新增门店独立成条、标题「{M}月{D}日新增{N}家门店」（**数量入题、着重强调新增**，先例 #52「9月17日新增18家门店」）；舞讯公告（营业名单/恢复营业/确认营业中版式）不混【新增门店】段，用「{M}月{D}日舞讯更新」）：
